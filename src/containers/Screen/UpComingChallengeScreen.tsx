...
const UpComingChallengeScreen = (props: any) => {
  return (
    <View>
      <View>
        <ImageBackground
          style={styles.Image}
          source={require('../../assets/img/CityLight.jpeg')}>
          <TouchableOpacity
      ...
      <View style={styles.Layout}>
        <Text style={styles.Text1}>City lights in nights</Text>
        <View style={styles.Layout2}>
          <Image
            style={styles.Clock}
            source={require('../../assets/img/clock.png')}
          />
          <Text style={styles.Text2}>1day to start</Text>
        </View>
...
export default UpComingChallengeScreen;
